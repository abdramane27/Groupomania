    ...
    <div>
        <div class="container">
            <div class="row justify-content-center">
                ...
                <div class="col-12 col-md-10 col-lg-8">
                    <a href="" data-bs-toggle="modal" data-bs-target="#modalAddComment" class="my-2 btn btn-sm btn-block btn-success">Poster un commentaire...</a>
                    ...
                    <div v-for="comment in comments" :key="comment.id" class="card bg-light my-3">
                        <div class="card-header align-items-center m-0 p-1">
                            <div class="d-flex justify-content-between">
                                <span class="small text-dark m-0 p-1">
                                    Commentaire de <strong>{{comment.User.firstname}} {{comment.User.lastname}}</strong>
